...
namespace SehirRehberi.API.Controllers
{
    ...
    public class OgretmenlerController : BaseKisiController
	{
        //private IAppRepository _appRepository;
        //private IMapper _mapper;

        public OgretmenlerController(IAppRepository appRepository, IMapper mapper) : base()
		{
        ...
        [HttpGet]
        [Route("")]
        public override IActionResult GetOgretmenler()
        {
        ...
        [HttpGet]
        [Route("{id}")]
        public override IActionResult GetOgretmenlerById(int id)
        {
		...
		{
			var olddata = _appRepository.GetOgretmenlerById(id);
        ...
        {
            var datas = _appRepository.GetOgretmenler();
