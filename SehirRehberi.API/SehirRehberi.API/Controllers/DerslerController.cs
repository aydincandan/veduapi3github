...
namespace SehirRehberi.API.Controllers
{
    ...
    public class DerslerController : Controller
    {
        ...
        public DerslerController(IAppRepository appRepository, IMapper mapper)
        {
        ...
        [Route("create")]
        [Route("ekle")]
        public IActionResult Add([FromBody] Dersler newdata)
        {
        ...
        public IActionResult Gets()
        {
            ...
            var data = _appRepository.GetDersler(); ////////////////////////////////////////

            var dataToReturn = _mapper.Map<List<Dersler>>(data); // CityForListDto
        ...
        public IActionResult Get(int id)
        {
            ...
            var dataToReturn = _mapper.Map<Dersler>(data); // CityForDetailDto
