...
namespace SehirRehberi.API.Controllers
{
    ...
    public class AdminlerController : BaseKisiController
    {
        //private IAppRepository _appRepository;
        //private IMapper _mapper;

        public AdminlerController(IAppRepository appRepository, IMapper mapper) : base()
		{
		...
		[HttpGet]
        [Route("")]
        public override IActionResult GetAdminler()
        {
        ...
        [HttpGet]
        [Route("{id}")]
        public override IActionResult GetAdminlerById(int id)
        {
		...
		{
			var olddata = _appRepository.GetAdminlerById(id);
			...
			if (true)
			{
				...
				olddata.YetkiSeviye = newdata.YetkiSeviye;
			}
			else
			{
        ...
        {
            var datas = _appRepository.GetAdminler();
